...
-- local minihyper = {"ctrl", "shift"}
local minihyper = {"cmd", "alt"}
...
-- hs.hotkey.bind(minihyper, "a", launchOrCycleFocus("Atom"))
-- hs.hotkey.bind(minihyper, "t", launchOrCycleFocus("iTerm"))
-- hs.hotkey.bind(minihyper, "c", launchOrCycleFocus("Google Chrome"))
-- hs.hotkey.bind(minihyper, "v", launchOrCycleFocus("Visual Studio Code"))
-- hs.hotkey.bind(minihyper, "p", launchOrCycleFocus("Preview"))
-- hs.hotkey.bind(minihyper, "s", launchOrCycleFocus("Safari"))
-- hs.hotkey.bind(minihyper, "e", launchOrCycleFocus("Finder"))
-- hs.hotkey.bind(minihyper, "l", launchOrCycleFocus("Line"))
-- hs.hotkey.bind(minihyper, "n", launchOrCycleFocus("Nylas N1"))
...
hs.hotkey.bind(minihyper, "F", fullScreenCurrent)
hs.hotkey.bind(minihyper, "Right", screenToRight)
hs.hotkey.bind(minihyper, "Left", screenToLeft)
-- hs.hotkey.bind(minihyper, "Up", screenToUp)
-- hs.hotkey.bind(minihyper, "Down", screenToDown)
